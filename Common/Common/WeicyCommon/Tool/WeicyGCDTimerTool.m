...
@implementation WeicyGCDTimerTool

+ (WeicyGCDTimerTool *)sharedInstance {
    static WeicyGCDTimerTool *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[WeicyGCDTimerTool alloc] init];
    });
...
- (instancetype)init {
    ...
    if (self) {
        ...
        dispatch_queue_t queue = dispatch_queue_create("com.WCYGCDTimerTool.queue", attr);
        _queue = queue;
